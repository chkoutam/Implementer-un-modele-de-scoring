...
html_header="""
    <head>
        ...
        <meta name="author" content="Check KOUTAME">
...
st.markdown('<style>body{background-color: #78991f}</style>',unsafe_allow_html=True)
...
html_select_client="""
    <div class="card">
      <div class="card-body" style="border-radius: 10px 10px 0px 0px;
                  background:blueB; padding-top: 5px; width: auto;
                  height: 40px;">
        <h3 class="card-title" style="background-color:blue; color:white;
...
html_score="""
    <div class="card">
      <div class="card-body" style="border-radius: 10px 10px 0px 0px;
                  background: blue; padding-top: 5px; width: auto;
                  height: 40px;">
        <h3 class="card-title" style="background-color:blue; color:white;
                   font-family:Georgia; text-align: center; padding: 0px 0;">
          Crédit Score
...
def Affiche_jauge():  
    ...
    #y_proba = best_model.predict_proba(X_test_pred)[:, 1]
...
def Prediction():
    ...
    X_test = test_set[test_set['SK_ID_CURR'] == client_id]
    pred = best_model.predict(X_test.drop('SK_ID_CURR', axis=1))
...
<hr style= "  display: block;
  ...
  border-style: inset;
  border-width: 1.5px;">
<p style="color:Gray; text-align: right; font-size:12px;">Auteur : chkoutam@yahoo.fr - 04/07/2022</p>
"""
