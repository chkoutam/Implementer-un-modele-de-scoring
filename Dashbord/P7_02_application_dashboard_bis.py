            ...
            with st.expander('Comparaison variables impactantes client courant/moyennes des clients similaires',
                ...
                with st.container():
                    ...
                    with col1:
                        ...
                        plt.plot(x_gp1, y_moy_feat_voisins_gp3, color='Blue')
                    ...
                    with col2: 
                        ...
                        plt.plot(x_gp2, y_moy_feat_voisins_gp4, color='Blue')
...
<hr style= "  display: block;
  ...
  border-style: inset;
  border-width: 1.5px;">
<p style="color:Gray; text-align: right; font-size:12px;">Auteur : chkoutam@yahoo.fr - 07/07/2022</p>
"""
